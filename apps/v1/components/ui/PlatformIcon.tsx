 ...
 *
 * Renders social platform icons for various services.
 * Used across social link components.
 */
'use client';
...
import type { SocialPlatform } from '@/lib/types/social-links';
...
/**
 * Reddit SVG icon (not available in lucide-react)
 */
...
/**
 * Get CTA text for a platform
 */
export function getPlatformCTA(platform: SocialPlatform): string {
  switch (platform) {
    case 'youtube':
