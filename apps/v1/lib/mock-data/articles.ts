...
export const mockArticles: Article[] = [
  {
    ...
    title: 'Best Colorado Resorts for Beginners',
    excerpt: 'Starting your skiing journey? These Colorado mountains offer the perfect terrain and instruction for new skiers.',
    readTime: 5,
    image: 'https://images.unsplash.com/photo-1551524164-687a55dd1126?w=600',
    publishedAt: '2025-01-15',
  },
  {
    id: 'article:epic-vs-ikon',
    slug: 'epic-vs-ikon-which-pass',
  ...
  {
    id: 'article:powder-day-strategy',
    slug: 'powder-day-strategy-guide',
  ...
  {
    id: 'article:i70-traffic-tips',
    slug: 'i70-traffic-tips-colorado',
